...
PRIVATE uint8 s_au8apduMyDataInstance0Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance1Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance2Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance3Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance4Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance5Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance6Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance7Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance8Storage[100];
PRIVATE uint8 s_au8apduMyDataInstance9Storage[100];
PUBLIC pdum_tsAPduInstance s_asapduMyDataInstances[10] = {
    { s_au8apduMyDataInstance0Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance1Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance2Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance3Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance4Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance5Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance6Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance7Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance8Storage, 0, 0, 2 },
    { s_au8apduMyDataInstance9Storage, 0, 0, 2 },
};
